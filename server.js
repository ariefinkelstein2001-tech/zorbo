...
// Carga histórica 2025 — Fase 1, sección 2.1/2.2 del "Prompt maestro". Estos 4
// arrays vienen de extraer con precisión de celda (no transcripción a mano) las
// planillas ya VALIDADAS: Kairos_Historico_Limpio_2025.xlsx (hojas P&L_Cerveza
// y Litros_Canal → FORECAST_PNL_HISTORICO_2025_SEED y FORECAST_VENTAS_HISTORICAS
// _2025_SEED) e Ingresos_por_canal_y_detalle_por_producto.xlsx (hoja "Julio 2026
// CD", solo el bloque Kairos Brewing → FORECAST_MIX_ESTILO_HISTORICO_2025_SEED) y
// VENTAS_NUEVAS_2025.xlsx (hoja EVENTO Y MARKETING, bandera 5 → FORECAST_EVENTOS
// _HISTORICO_2025_SEED). Verificado: la suma de litros de
// FORECAST_VENTAS_HISTORICAS_2025_SEED por canal coincide EXACTO con la suma por
// estilo de FORECAST_MIX_ESTILO_HISTORICO_2025_SEED (99.082/96.528/11.486/27.586),
// que es lo que la sección 2.2 promete ("cuadra al litro"). El canal "cd_kairos"
// acá representa el bucket combinado HORECA + Venta Online: el archivo histórico
// no trae el split CD Kairos vs 500 Sabores vs Venta Online para 2025 (bandera 6),
// así que "ventas_cruzada" queda sin dato histórico 2025 — hueco real, no se
// inventa. cd_kairos = HORECA+VentaOnline consolidado; garden = Hospitality
// Vespucio; badass/antofagasta = es_apertura marcado en jun/oct-2025 (banderas
// 1 y 2). pnl: monto ya viene con el signo del rubro (costo/gastos negativos),
// para que Resultado = suma(monto) reproduzca la fórmula validada de la sección
// 7.1 sin duplicar lógica de signo en otro lado.
const FORECAST_VENTAS_HISTORICAS_2025_SEED = [{"fecha": "2025-01", "canal": "cd_kairos", "litros": 9355, "ingreso": 38897467, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-02", "canal": "cd_kairos", "litros": 7740, "ingreso": 31175120, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-03", "canal": "cd_kairos", "litros": 7293, "ingreso": 29593641, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-04", "canal": "cd_kairos", "litros": 6989, "ingreso": 28914965, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-05", "canal": "cd_kairos", "litros": 7723, "ingreso": 31583011, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-06", "canal": "cd_kairos", "litros": 7404, "ingreso": 29804135, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-07", "canal": "cd_kairos", "litros": 8337, "ingreso": 34327856, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-08", "canal": "cd_kairos", "litros": 8304, "ingreso": 36003908, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-09", "canal": "cd_kairos", "litros": 7929, "ingreso": 28044309, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-10", "canal": "cd_kairos", "litros": 9656, "ingreso": 37878143, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-11", "canal": "cd_kairos", "litros": 7739, "ingreso": 29000769, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-12", "canal": "cd_kairos", "litros": 10613, "ingreso": 41629876, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-01", "canal": "garden", "litros": 8767, "ingreso": 6899629, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-02", "canal": "garden", "litros": 8027, "ingreso": 6448524, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-03", "canal": "garden", "litros": 8362, "ingreso": 4412044, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-04", "canal": "garden", "litros": 6674, "ingreso": 4157902, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-05", "canal": "garden", "litros": 8335, "ingreso": 4775955, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-06", "canal": "garden", "litros": 5910, "ingreso": 11920536, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-07", "canal": "garden", "litros": 7961, "ingreso": 16102216, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-08", "canal": "garden", "litros": 8121, "ingreso": 16340604, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-09", "canal": "garden", "litros": 7521, "ingreso": 15090328, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-10", "canal": "garden", "litros": 8950, "ingreso": 18301672, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-11", "canal": "garden", "litros": 9000, "ingreso": 18564908, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-12", "canal": "garden", "litros": 8900, "ingreso": 18266322, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-06", "canal": "badass", "litros": 1197, "ingreso": 657153, "esApertura": true, "origen": "historico_2025"}, {"fecha": "2025-07", "canal": "badass", "litros": 1532, "ingreso": 2300317, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-08", "canal": "badass", "litros": 1315, "ingreso": 1080720, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-09", "canal": "badass", "litros": 1512, "ingreso": 1211112, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-10", "canal": "badass", "litros": 1870, "ingreso": 1571562, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-11", "canal": "badass", "litros": 2390, "ingreso": 1988883, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-12", "canal": "badass", "litros": 1670, "ingreso": 1402551, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-08", "canal": "antofagasta", "litros": 2500, "ingreso": 4996000, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-09", "canal": "antofagasta", "litros": 7460, "ingreso": 7933500, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-10", "canal": "antofagasta", "litros": 8496, "ingreso": 10615980, "esApertura": true, "origen": "historico_2025"}, {"fecha": "2025-11", "canal": "antofagasta", "litros": 1930, "ingreso": 5552550, "esApertura": false, "origen": "historico_2025"}, {"fecha": "2025-12", "canal": "antofagasta", "litros": 7200, "ingreso": 14976231, "esApertura": false, "origen": "historico_2025"}];
const FORECAST_PNL_HISTORICO_2025_SEED = [{"mes": "2025-01", "unidadNegocio": "cerveza", "rubro": "ingreso", "monto": 36056019, "origen": "historico_2025"}, {"mes": "2025-02", "unidadNegocio": "cerveza", "rubro": "ingreso", "monto": 50524132, "origen": "historico_2025"}, {"mes": "2025-03", "unidadNegocio": "cerveza", "rubro": "ingreso", "monto": 47539240, "origen": "historico_2025"}, {"mes": "2025-04", "unidadNegocio": "cerveza", "rubro": "ingreso", "monto": 54709668, "origen": "historico_2025"}, {"mes": "2025-05", "unidadNegocio": "cerveza", "rubro": "ingreso", "monto": 40682168, "origen": "historico_2025"}, {"mes": "2025-06", "unidadNegocio": "cerveza", "rubro": "ingreso", "monto": 46331294, "origen": "historico_2025"}, {"mes": "2025-07", "unidadNegocio": "cerveza", "rubro": "ingreso", "monto": 54847216, "origen": "historico_2025"}, {"mes": "2025-08", "unidadNegocio": "cerveza", "rubro": "ingreso", "monto": 61719269, "origen": "historico_2025"}, {"mes": "2025-09", "unidadNegocio": "cerveza", "rubro": "ingreso", "monto": 56036447, "origen": "historico_2025"}, {"mes": "2025-10", "unidadNegocio": "cerveza", "rubro": "ingreso", "monto": 75382754, "origen": "historico_2025"}, {"mes": "2025-11", "unidadNegocio": "cerveza", "rubro": "ingreso", "monto": 58602590, "origen": "historico_2025"}, {"mes": "2025-12", "unidadNegocio": "cerveza", "rubro": "ingreso", "monto": 78592493, "origen": "historico_2025"}, {"mes": "2025-01", "unidadNegocio": "cerveza", "rubro": "costo", "monto": -28802269, "origen": "historico_2025"}, {"mes": "2025-02", "unidadNegocio": "cerveza", "rubro": "costo", "monto": -29396652, "origen": "historico_2025"}, {"mes": "2025-03", "unidadNegocio": "cerveza", "rubro": "costo", "monto": -29448283, "origen": "historico_2025"}, {"mes": "2025-04", "unidadNegocio": "cerveza", "rubro": "costo", "monto": -32666181, "origen": "historico_2025"}, {"mes": "2025-05", "unidadNegocio": "cerveza", "rubro": "costo", "monto": -23119830, "origen": "historico_2025"}, {"mes": "2025-06", "unidadNegocio": "cerveza", "rubro": "costo", "monto": -26363679, "origen": "historico_2025"}, {"mes": "2025-07", "unidadNegocio": "cerveza", "rubro": "costo", "monto": -28546822, "origen": "historico_2025"}, {"mes": "2025-08", "unidadNegocio": "cerveza", "rubro": "costo", "monto": -40796933, "origen": "historico_2025"}, {"mes": "2025-09", "unidadNegocio": "cerveza", "rubro": "costo", "monto": -40649123, "origen": "historico_2025"}, {"mes": "2025-10", "unidadNegocio": "cerveza", "rubro": "costo", "monto": -46676974, "origen": "historico_2025"}, {"mes": "2025-11", "unidadNegocio": "cerveza", "rubro": "costo", "monto": -58095712, "origen": "historico_2025"}, {"mes": "2025-12", "unidadNegocio": "cerveza", "rubro": "costo", "monto": -67621345, "origen": "historico_2025"}, {"mes": "2025-01", "unidadNegocio": "cerveza", "rubro": "gasto_operativo", "monto": -3815830, "origen": "historico_2025"}, {"mes": "2025-02", "unidadNegocio": "cerveza", "rubro": "gasto_operativo", "monto": -4481727, "origen": "historico_2025"}, {"mes": "2025-03", "unidadNegocio": "cerveza", "rubro": "gasto_operativo", "monto": -5907424, "origen": "historico_2025"}, {"mes": "2025-04", "unidadNegocio": "cerveza", "rubro": "gasto_operativo", "monto": -5737557, "origen": "historico_2025"}, {"mes": "2025-05", "unidadNegocio": "cerveza", "rubro": "gasto_operativo", "monto": -6278024, "origen": "historico_2025"}, {"mes": "2025-06", "unidadNegocio": "cerveza", "rubro": "gasto_operativo", "monto": -5327971, "origen": "historico_2025"}, {"mes": "2025-07", "unidadNegocio": "cerveza", "rubro": "gasto_operativo", "monto": -4131308, "origen": "historico_2025"}, {"mes": "2025-08", "unidadNegocio": "cerveza", "rubro": "gasto_operativo", "monto": -4374465, "origen": "historico_2025"}, {"mes": "2025-09", "unidadNegocio": "cerveza", "rubro": "gasto_operativo", "monto": -5277347, "origen": "historico_2025"}, {"mes": "2025-10", "unidadNegocio": "cerveza", "rubro": "gasto_operativo", "monto": -8815677, "origen": "historico_2025"}, {"mes": "2025-11", "unidadNegocio": "cerveza", "rubro": "gasto_operativo", "monto": -5284468, "origen": "historico_2025"}, {"mes": "2025-12", "unidadNegocio": "cerveza", "rubro": "gasto_operativo", "monto": -8279821, "origen": "historico_2025"}, {"mes": "2025-01", "unidadNegocio": "cerveza", "rubro": "gav", "monto": -3392678, "origen": "historico_2025"}, {"mes": "2025-02", "unidadNegocio": "cerveza", "rubro": "gav", "monto": -975384, "origen": "historico_2025"}, {"mes": "2025-03", "unidadNegocio": "cerveza", "rubro": "gav", "monto": -1983345, "origen": "historico_2025"}, {"mes": "2025-04", "unidadNegocio": "cerveza", "rubro": "gav", "monto": -14453256, "origen": "historico_2025"}, {"mes": "2025-05", "unidadNegocio": "cerveza", "rubro": "gav", "monto": -4222627, "origen": "historico_2025"}, {"mes": "2025-06", "unidadNegocio": "cerveza", "rubro": "gav", "monto": -4962157, "origen": "historico_2025"}, {"mes": "2025-07", "unidadNegocio": "cerveza", "rubro": "gav", "monto": -11202334, "origen": "historico_2025"}, {"mes": "2025-08", "unidadNegocio": "cerveza", "rubro": "gav", "monto": -4104467, "origen": "historico_2025"}, {"mes": "2025-09", "unidadNegocio": "cerveza", "rubro": "gav", "monto": -4289890, "origen": "historico_2025"}, {"mes": "2025-10", "unidadNegocio": "cerveza", "rubro": "gav", "monto": -8963107, "origen": "historico_2025"}, {"mes": "2025-11", "unidadNegocio": "cerveza", "rubro": "gav", "monto": 0, "origen": "historico_2025"}, {"mes": "2025-12", "unidadNegocio": "cerveza", "rubro": "gav", "monto": -9681104, "origen": "historico_2025"}];
const FORECAST_MIX_ESTILO_HISTORICO_2025_SEED = [{"canal": "cd_kairos", "estilo": "Pils", "fecha": "2025-01", "litros": 1871.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Pils", "fecha": "2025-02", "litros": 1555.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Pils", "fecha": "2025-03", "litros": 1588.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Pils", "fecha": "2025-04", "litros": 1238.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Pils", "fecha": "2025-05", "litros": 1498.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Pils", "fecha": "2025-06", "litros": 1516.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Pils", "fecha": "2025-07", "litros": 1457.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Pils", "fecha": "2025-08", "litros": 1825.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Pils", "fecha": "2025-09", "litros": 1700.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Pils", "fecha": "2025-10", "litros": 1901.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Pils", "fecha": "2025-11", "litros": 1536.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Pils", "fecha": "2025-12", "litros": 2015.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Red", "fecha": "2025-01", "litros": 406.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Red", "fecha": "2025-02", "litros": 351.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Red", "fecha": "2025-03", "litros": 337.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Red", "fecha": "2025-04", "litros": 553.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Red", "fecha": "2025-05", "litros": 424.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Red", "fecha": "2025-06", "litros": 337.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Red", "fecha": "2025-07", "litros": 813.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Red", "fecha": "2025-08", "litros": 240.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Red", "fecha": "2025-09", "litros": 385.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Red", "fecha": "2025-10", "litros": 444.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Red", "fecha": "2025-11", "litros": 549.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Red", "fecha": "2025-12", "litros": 625.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Golden", "fecha": "2025-01", "litros": 3767.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Golden", "fecha": "2025-02", "litros": 3158.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Golden", "fecha": "2025-03", "litros": 3351.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Golden", "fecha": "2025-04", "litros": 2802.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Golden", "fecha": "2025-05", "litros": 3368.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Golden", "fecha": "2025-06", "litros": 3138.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Golden", "fecha": "2025-07", "litros": 3872.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Golden", "fecha": "2025-08", "litros": 3947.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Golden", "fecha": "2025-09", "litros": 3603.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Golden", "fecha": "2025-10", "litros": 4156.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Golden", "fecha": "2025-11", "litros": 3103.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Golden", "fecha": "2025-12", "litros": 4694.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "NEIPA", "fecha": "2025-01", "litros": 115.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "NEIPA", "fecha": "2025-03", "litros": 28.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "NEIPA", "fecha": "2025-04", "litros": 34.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "NEIPA", "fecha": "2025-05", "litros": 34.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "NEIPA", "fecha": "2025-06", "litros": 32.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "NEIPA", "fecha": "2025-07", "litros": 48.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "NEIPA", "fecha": "2025-08", "litros": 3.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "NEIPA", "fecha": "2025-09", "litros": 24.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "NEIPA", "fecha": "2025-10", "litros": 108.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "NEIPA", "fecha": "2025-11", "litros": 37.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "NEIPA", "fecha": "2025-12", "litros": 123.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "APA", "fecha": "2025-01", "litros": 1725.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "APA", "fecha": "2025-02", "litros": 1209.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "APA", "fecha": "2025-03", "litros": 846.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "APA", "fecha": "2025-04", "litros": 1041.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "APA", "fecha": "2025-05", "litros": 1292.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "APA", "fecha": "2025-06", "litros": 1533.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "APA", "fecha": "2025-07", "litros": 1158.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "APA", "fecha": "2025-08", "litros": 1376.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "APA", "fecha": "2025-09", "litros": 1357.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "APA", "fecha": "2025-10", "litros": 1799.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "APA", "fecha": "2025-11", "litros": 1494.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "APA", "fecha": "2025-12", "litros": 2136.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Weizen", "fecha": "2025-03", "litros": 48.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Weizen", "fecha": "2025-04", "litros": 30.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Weizen", "fecha": "2025-05", "litros": 11.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Weizen", "fecha": "2025-07", "litros": 26.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Weizen", "fecha": "2025-10", "litros": 108.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Weizen", "fecha": "2025-11", "litros": 40.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Italian Pils", "fecha": "2025-01", "litros": 1374.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Italian Pils", "fecha": "2025-02", "litros": 1200.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Italian Pils", "fecha": "2025-03", "litros": 1050.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Italian Pils", "fecha": "2025-04", "litros": 1182.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Italian Pils", "fecha": "2025-05", "litros": 1048.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Italian Pils", "fecha": "2025-06", "litros": 805.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Italian Pils", "fecha": "2025-07", "litros": 957.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Italian Pils", "fecha": "2025-08", "litros": 900.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Italian Pils", "fecha": "2025-09", "litros": 825.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Italian Pils", "fecha": "2025-10", "litros": 1140.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Italian Pils", "fecha": "2025-11", "litros": 980.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Italian Pils", "fecha": "2025-12", "litros": 1020.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Colección de Artista", "fecha": "2025-01", "litros": 97.0, "origen": "historico_2025"}, {"canal": "cd_kairos", "estilo": "Colección de Artista", "fecha": "2025
0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "NEIPA", "fecha": "2025-12", "litros": 300.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "APA", "fecha": "2025-08", "litros": 500.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "APA", "fecha": "2025-09", "litros": 540.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "APA", "fecha": "2025-10", "litros": 585.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "APA", "fecha": "2025-11", "litros": 1000.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "APA", "fecha": "2025-12", "litros": 1000.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Ámbar", "fecha": "2025-09", "litros": 160.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Ámbar", "fecha": "2025-10", "litros": 11.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Weizen", "fecha": "2025-09", "litros": 950.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Weizen", "fecha": "2025-10", "litros": 484.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Weizen", "fecha": "2025-12", "litros": 120.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "IPA", "fecha": "2025-09", "litros": 240.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "IPA", "fecha": "2025-10", "litros": 11.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "IPA", "fecha": "2025-12", "litros": 120.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Stout", "fecha": "2025-09", "litros": 240.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Stout", "fecha": "2025-10", "litros": 484.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Stout", "fecha": "2025-11", "litros": 450.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Stout", "fecha": "2025-12", "litros": 180.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Hoppy Lager", "fecha": "2025-09", "litros": 240.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Hoppy Lager", "fecha": "2025-10", "litros": 11.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Hoppy Lager", "fecha": "2025-12", "litros": 180.0, "origen": "historico_2025"}, {"canal": "antofagasta", "estilo": "Colección de Artista", "fecha": "2025-09", "litros": 570.0, "origen": "historico_2025"}];
const FORECAST_EVENTOS_HISTORICO_2025_SEED = [{"estilo": "Golden", "fecha": "2025-01-01", "formato": "barril20", "litros": 97.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Golden", "fecha": "2025-03-01", "formato": "barril20", "litros": 3.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Golden", "fecha": "2025-04-01", "formato": "barril20", "litros": 4.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Golden", "fecha": "2025-07-01", "formato": "barril20", "litros": 6.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Golden", "fecha": "2025-08-01", "formato": "barril20", "litros": 36.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Golden", "fecha": "2025-09-01", "formato": "barril20", "litros": 17.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Golden", "fecha": "2025-10-01", "formato": "barril20", "litros": 60.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Golden", "fecha": "2025-10-01", "formato": "lata", "litros": 38.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Golden", "fecha": "2025-11-01", "formato": "barril20", "litros": 20.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Golden", "fecha": "2025-11-01", "formato": "lata", "litros": 10.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Golden", "fecha": "2025-12-01", "formato": "barril20", "litros": 80.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Golden", "fecha": "2025-12-01", "formato": "lata", "litros": 47.77, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-01-01", "formato": "barril20", "litros": 100.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-03-01", "formato": "barril20", "litros": 11.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-04-01", "formato": "barril20", "litros": 70.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-05-01", "formato": "barril20", "litros": 20.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-07-01", "formato": "barril20", "litros": 6.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-08-01", "formato": "barril20", "litros": 65.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-09-01", "formato": "barril20", "litros": 28.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-10-01", "formato": "barril20", "litros": 320.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-10-01", "formato": "lata", "litros": 73.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-11-01", "formato": "barril20", "litros": 20.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-11-01", "formato": "lata", "litros": 15.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-12-01", "formato": "barril20", "litros": 90.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Pils", "fecha": "2025-12-01", "formato": "lata", "litros": 61.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Red", "fecha": "2025-01-01", "formato": "barril20", "litros": 113.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Red", "fecha": "2025-03-01", "formato": "barril20", "litros": 13.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Red", "fecha": "2025-04-01", "formato": "barril20", "litros": 51.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Red", "fecha": "2025-07-01", "formato": "barril20", "litros": 5.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Red", "fecha": "2025-08-01", "formato": "barril20", "litros": 25.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Red", "fecha": "2025-09-01", "formato": "barril20", "litros": 13.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Red", "fecha": "2025-10-01", "formato": "barril20", "litros": 50.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Red", "fecha": "2025-10-01", "formato": "lata", "litros": 31.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Red", "fecha": "2025-11-01", "formato": "lata", "litros": 12.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Red", "fecha": "2025-12-01", "formato": "lata", "litros": 58.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "APA", "fecha": "2025-01-01", "formato": "barril20", "litros": 98.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "APA", "fecha": "2025-03-01", "formato": "barril20", "litros": 10.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "APA", "fecha": "2025-04-01", "formato": "barril20", "litros": 40.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "APA", "fecha": "2025-05-01", "formato": "barril20", "litros": 20.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "APA", "fecha": "2025-07-01", "formato": "barril20", "litros": 6.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "APA", "fecha": "2025-08-01", "formato": "barril20", "litros": 5.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "APA", "fecha": "2025-09-01", "formato": "barril20", "litros": 17.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "APA", "fecha": "2025-10-01", "formato": "lata", "litros": 11.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "APA", "fecha": "2025-11-01", "formato": "lata", "litros": 9.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "APA", "fecha": "2025-12-01", "formato": "lata", "litros": 57.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "NEIPA", "fecha": "2025-01-01", "formato": "barril20", "litros": 90.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "NEIPA", "fecha": "2025-03-01", "formato": "barril20", "litros": 11.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "NEIPA", "fecha": "2025-04-01", "formato": "barril20", "litros": 72.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "NEIPA", "fecha": "2025-07-01", "formato": "barril20", "litros": 25.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "NEIPA", "fecha": "2025-08-01", "formato": "barril20", "litros": 56.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "NEIPA", "fecha": "2025-09-01", "formato": "barril20", "litros": 32.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "NEIPA", "fecha": "2025-10-01", "formato": "barril20", "litros": 60.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "NEIPA", "fecha": "2025-10-01", "formato": "lata", "litros": 73.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "NEIPA", "fecha": "2025-11-01", "formato": "lata", "litros": 8.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "NEIPA", "fecha": "2025-12-01", "formato": "barril20", "litros": 60.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "NEIPA", "fecha": "2025-12-01", "formato": "lata", "litros": 75.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Weizen", "fecha": "2025-03-01", "formato": "barril20", "litros": 9.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Weizen", "fecha": "2025-04-01", "formato": "barril20", "litros": 37.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Weizen", "fecha": "2025-07-01", "formato": "barril20", "litros": 5.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Weizen", "fecha": "2025-08-01", "formato": "barril20", "litros": 7.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Weizen", "fecha": "2025-09-01", "formato": "barril20", "litros": 28.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Weizen", "fecha": "2025-10-01", "formato": "barril20", "litros": 150.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Weizen", "fecha": "2025-10-01", "formato": "lata", "litros": 12.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Weizen", "fecha": "2025-12-01", "formato": "lata", "litros": 2.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Hoppy Lager", "fecha": "2025-10-01", "formato": "barril20", "litros": 120.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Hoppy Lager", "fecha": "2025-10-01", "formato": "lata", "litros": 1.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Hoppy Lager", "fecha": "2025-11-01", "formato": "lata", "litros": 20.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Hoppy Lager", "fecha": "2025-12-01", "formato": "barril20", "litros": 30.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Hoppy Lager", "fecha": "2025-12-01", "formato": "lata", "litros": 1.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "IPA", "fecha": "2025-11-01", "formato": "barril20", "litros": 30.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "IPA", "fecha": "2025-12-01", "formato": "lata", "litros": 2.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Ámbar", "fecha": "2025-11-01", "formato": "lata", "litros": 2.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Ámbar", "fecha": "2025-12-01", "formato": "lata", "litros": 2.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Stout", "fecha": "2025-10-01", "formato": "lata", "litros": 2.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Stout", "fecha": "2025-12-01", "formato": "lata", "litros": 2.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-01-01", "formato": "barril20", "litros": 292.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-03-01", "formato": "barril20", "litros": 33.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-04-01", "formato": "barril20", "litros": 67.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-07-01", "formato": "barril20", "litros": 9.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-08-01", "formato": "barril20", "litros": 13.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-09-01", "formato": "barril20", "litros": 50.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-10-01", "formato": "lata", "litros": 23.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-12-01", "formato": "lata", "litros": 64.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-10-01", "formato": "barril20", "litros": 120.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-10-01", "formato": "lata", "litros": 7.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-10-01", "formato": "barril20", "litros": 360.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-10-01", "formato": "lata", "litros": 56.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-11-01", "formato": "lata", "litros": 9.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}, {"estilo": "Colección de Artista", "fecha": "2025-11-01", "formato": "lata", "litros": 3.0, "motivo": "Evento/Marketing 2025 (carga histórica planilla limpia)"}];

function forecastDataDefaults(){
  return { sinonimos: {}, loteEstilo: { ...FORECAST_LOTE_ESTILO_SEED }, driverExterno: [], traspasos500: [], eventos: [], capacidadMaquila: [], capacidad: [], parametros: [], analogos: [], inventarioActual: [], quiebres: [], barrilesEventos: [], ventasHistoricas: [], mixEstiloHistorico: [], pnlHistorico: [], historico2025Cargado: false };
}
  ...
  try {
    if (existsSync(FORECAST_OP_FILE)) {
      ...
      if (p && typeof p === 'object') {
        ...
        for (const k of ['driverExterno', 'traspasos500', 'eventos', 'capacidadMaquila', 'capacidad', 'parametros', 'analogos', 'inventarioActual', 'quiebres', 'barrilesEventos', 'ventasHistoricas', 'mixEstiloHistorico', 'pnlHistorico']) {
          if (Array.isArray(p[k])) d[k] = p[k];
        }
        if (p.historico2025Cargado) d.historico2025Cargado = true;
      }
    }
  } catch (e) { console.warn('forecast-data load:', e.message); }
  // Carga histórica 2025 (una sola vez): la marca historico2025Cargado evita que
  // se vuelva a insertar en cada arranque — después de la primera carga, cada fila
  // es editable/borrable como cualquier otra (misma vía que las cargadas a mano),
  // así que si alguien la corrige o la borra, no vuelve a aparecer sola.
  if (!d.historico2025Cargado) {
    const conId = (arr) => arr.map(e => ({ id: randomBytes(6).toString('hex'), ...e }));
    d.ventasHistoricas = [...d.ventasHistoricas, ...conId(FORECAST_VENTAS_HISTORICAS_2025_SEED)];
    d.mixEstiloHistorico = [...d.mixEstiloHistorico, ...conId(FORECAST_MIX_ESTILO_HISTORICO_2025_SEED)];
    d.pnlHistorico = [...d.pnlHistorico, ...conId(FORECAST_PNL_HISTORICO_2025_SEED)];
    d.eventos = [...d.eventos, ...conId(FORECAST_EVENTOS_HISTORICO_2025_SEED)];
    d.historico2025Cargado = true;
    forecastDataSave(d);
  }
  return d;
}
...
async function forecastVentasDelMes(month, data){
  const d = data || forecastDataLoad();
  const rows = [];
  // Histórico 2025 (carga validada, sección 2.1/2.2 del documento): para cada
  // canal que el histórico cubre en este mes, es la fuente ÚNICA — nunca se suma
  // encima el recálculo en vivo del mismo canal/mes (evita doble conteo). Los
  // canales/meses que el histórico NO cubre (ventas_cruzada 2025, cualquier canal
  // fuera de 2025) siguen resolviéndose en vivo vía Shopify, como antes.
  const histCanales = new Set((d.ventasHistoricas || []).filter(r => r.fecha === month).map(r => r.canal));
  for (const r of (d.mixEstiloHistorico || [])) {
    if (r.fecha === month && histCanales.has(r.canal)) rows.push({ fecha: month + '-01', canal: r.canal, estilo: r.estilo, litros: r.litros, origen: 'historico_2025' });
  }
  let shopifyError = null;
  try {
    const est = await estadoResolve(month, null);
    if (!est.shopifyOk) { shopifyError = est.shopifyError || 'Shopify no disponible para este mes.'; }
    else {
      const add = (fecha, canal, estilo, litros) => {
        if (histCanales.has(canal)) return; // ya cubierto por el histórico validado, no duplicar
        const lt = Number(litros) || 0; if (!fecha || !lt || !estilo || estilo === 'sin mapear') return;
        rows.push({ fecha, canal, estilo: forecastNormalizeEstilo(estilo, d), litros: lt, origen: 'api' });
      };
  ...
  } catch (e) { shopifyError = String(e.message || e).slice(0, 200); }
  // Solo es un error real si el mes no tiene NINGÚN dato: ni histórico ni Shopify.
  if (!rows.length && shopifyError) return { rows, error: shopifyError };
  return { rows, error: null };
}
// Cifras de referencia 2025 — la hoja Litros_Canal de Kairos_Historico_Limpio_2025.xlsx
// (para la validación de reconciliación de Fase 1, sección 13) — NO son un cálculo
// del sistema, son el ancla externa contra la que se compara lo que el sistema
// efectivamente suma. eventos: total real de la hoja EVENTO Y MARKETING de
// VENTAS_NUEVAS_2025.xlsx (4.071,77 ≈ 4.072). total: suma de los 4 canales +
// eventos (238.754), distinto de TOTAL LITROS CERVEZA del histórico limpio
// (234.682) porque esa hoja no incluye eventos — ver LEEME / bandera 8.
const FORECAST_RECON_REF = {
  '2025': { cd_kairos: 99082, garden: 96528, antofagasta: 27586, badass: 11486, eventos: 4072, total: 238754 },
};
...
// ─── Forecast Operacional · Financiero (unidad cerveza) — sección 7 del documento ──
// P&L histórico cargado desde la planilla limpia (pnlHistorico, seed de arriba).
// Rotulado explícitamente "unidad cerveza": el error real que motivó la regla de
// oro de las fuentes (sección 2) fue mezclar el P&L del grupo completo (~$4.151M,
// vive en las hojas ACUMULADO/KAIROS GARDEN del Control de Cierre, nunca se carga)
// con el de la cervecería — daba una pérdida de $2.800M inexistente. Monto de cada
// rubro ya viene con el signo correcto (costo/gastos negativos) desde la carga, así
// que Resultado = suma de los 4 rubros reproduce la fórmula validada sin lógica de
// signo duplicada acá.
const FORECAST_PNL_RUBROS = ['ingreso', 'costo', 'gasto_operativo', 'gav'];
async function forecastFinanciero(year, data){
  const d = data || forecastDataLoad();
  const filas = (d.pnlHistorico || []).filter(r => String(r.mes || '').slice(0, 4) === year && r.unidadNegocio === 'cerveza');
  if (!filas.length) return { ok: false, reason: 'sin_datos', year };
  const meses = Array.from({ length: 12 }, (_, i) => year + '-' + String(i + 1).padStart(2, '0'));
  const porMes = meses.map(mes => {
    const deMes = filas.filter(f => f.mes === mes);
    const porRubro = {}; FORECAST_PNL_RUBROS.forEach(r => { porRubro[r] = deMes.filter(f => f.rubro === r).reduce((a, f) => a + f.monto, 0); });
    const resultado = FORECAST_PNL_RUBROS.reduce((a, r) => a + porRubro[r], 0);
    return { mes, ...porRubro, resultado, tieneDatos: deMes.length > 0 };
  });
  const totales = {}; FORECAST_PNL_RUBROS.forEach(r => { totales[r] = Math.round(porMes.reduce((a, m) => a + m[r], 0)); });
  totales.resultado = Math.round(porMes.reduce((a, m) => a + m.resultado, 0));
  const margenBrutoPct = totales.ingreso ? Math.round(((totales.ingreso + totales.costo) / totales.ingreso) * 1000) / 10 : null;
  const margenOperativoPct = totales.ingreso ? Math.round((totales.resultado / totales.ingreso) * 1000) / 10 : null;
  return { ok: true, year, unidadNegocio: 'cerveza', porMes, totales, margenBrutoPct, margenOperativoPct, personasIncluido: false };
}
app.get('/admin/forecast/financiero', requireAdmin, async (req, res) => {
  const year = /^\d{4}$/.test(String(req.query.year)) ? String(req.query.year) : '2025';
  try { res.json(await forecastFinanciero(year, forecastDataLoad())); }
...
// Listas de solo-lectura (cargadas en bloque desde la planilla limpia, sección 2.1/
// 2.2) que no tienen formulario de alta manual — se agregan SOLO al set de borrado
// genérico (auditable: cada fila se puede inspeccionar/quitar una por una si se
// detecta un error), nunca al de creación (no tienen forma validada de un registro
// suelto: fecha+canal+estilo+litros+ingreso a mano perdería la trazabilidad al
// origen que sí tiene la carga en bloque).
const FORECAST_DELETE_LISTS = [...FORECAST_LISTS, 'ventasHistoricas', 'mixEstiloHistorico', 'pnlHistorico'];
...
app.delete('/admin/forecast/data/:list/:id', requireAdmin, (req, res) => {
  const list = req.params.list;
  if (!FORECAST_DELETE_LISTS.includes(list)) return res.status(400).json({ error: 'Lista inválida.' });
